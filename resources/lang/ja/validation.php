...
return [
    ...
    */
    ...
    'custom' => [
        'last_name_furigana' => [
            'required' => '苗字のフリガナ入力は必須です',
            'regex' => 'フリガナは全角カタカナで入力してください',
        ],
        'first_name_furigana' => [
            'required' => '名前のフリガナ入力は必須です',
            'regex' => 'フリガナは全角カタカナで入力してください',
        ],
        'birth_date' => [
            'required' => '生年月日の入力は必須です',
            'date_format' => '生年月日は1900-06-02形式で入力してください',
            'before' => '生年月日は今日より前の日付を入力してください'
        ],
        'tel' => [
            'regex' => '電話番号はハイフンを入力してください',
        ],
        'postal_code' => [
            'required' => '郵便番号の入力は必須です',
            'regex' => '郵便番号は000-0000形式で入力してください',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'pregecture' => '都道府県の入力',
        'after_address' => '番地の入力',
        'closest_station' => '最寄駅の入力',
        'educational_background' => '最終学歴の入力',
        'resume' => '履歴書',
        'job_history_sheet' => '職務履歴書',
    ],

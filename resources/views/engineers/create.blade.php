<html lang="ja">
    ...
    <body>
        ...
        <form action="{{ route('engineers.confirm') }}" method="post" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
            ...
            <div class="form">
                ...
                <input name="postal_code" pattern="^[0-9]{3}-[0-9]{4}$" value="{{ old('postal_code') }}" required placeholder="000-0000"><br>
                <label>都道府県 <span>必須</span></label><br>
                <input name="prefecture" value="{{ old('prefecture') }}" required placeholder="都道府県"><br>
                <label>市</label><br>
                <input name="city" value="{{ old('city') }}" placeholder="市"><br>
                <label>町名</label><br>
                <input name="town" value="{{ old('town') }}" placeholder="町名"><br>
                <label>町名以下 <span>必須</span></label><br>
                <input name="after_address" value="{{ old('after_address') }}" required placeholder="町名以下"><br>
